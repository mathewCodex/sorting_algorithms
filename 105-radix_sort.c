...
/**
 * radix_counting_sort - sort the significant digits of an array of int
...
/**
 * radix_sort - sort an arr of int in ascending
 *              order using radix sort algorithm
 * @array: An array of int
 * @size: size of the arr
 *
 * Description: implement the LSD radix sort algo.
