...
/**
 * swap_integers - swap two int in arr
 ...
 * @array: an arr olf int
 * @size: the size of array
 * @start: the start idx of the sequence in arr to sort
 ...
 * @start: the start idx of a block of the building bitonic
 * @seq: the size of a block of the building bitonic seq
 * @flow: the direction to sort the bitonic seq
 */
void bitonic_seq(int *array, size_t size, size_t start, size_t seq, char flow)
{
	size_t cut = seq / 2;
